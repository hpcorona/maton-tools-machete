...
public class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
	...
	public void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
		int numConfigs = configs.length;
		Log.w("Maton", String.format("%d configurations", numConfigs));
		for (int i = 0; i < numConfigs; i++) {
			Log.w("Maton", String.format("Configuration %d:\n", i));
	...
	public static String printConfig(EGL10 egl, EGLDisplay display, EGLConfig config) {
		int[] attributes = { EGL10.EGL_BUFFER_SIZE, EGL10.EGL_ALPHA_SIZE,
				...
				EGL10.EGL_COLOR_BUFFER_TYPE, EGL10.EGL_RENDERABLE_TYPE, 0x3042 // EGL10.EGL_CONFORMANT
		};
