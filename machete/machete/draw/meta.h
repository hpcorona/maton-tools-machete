...
namespace machete {
  namespace draw {
    ...
    class MetaElement {
    public:
      virtual void Draw(DrawContext *ctx, const Vec2 & pos, const Vec2 & scale, const Vec4 & color, float rotation, bool flipX, bool flipY) = 0;
    ...
    public:
      ...
      void Draw(DrawContext *ctx, const Vec2 & pos, const Vec2 & scale, const Vec4 & color, float rotation, bool flipX, bool flipY);
